...
async function main() {
  ...
  results.push(await runBenchmark('Simple Template (baseline)', async () => {
    await include({
  ...
  results.push(await runBenchmark('Fn::Map (10 items)', async () => {
    await include({
  ...
  results.push(await runBenchmark('Fn::Map (100 items)', async () => {
    await include({
  ...
  results.push(await runBenchmark('Fn::Map (1000 items)', async () => {
    await include({
  ...
  // 5. Nested Map (3-deep)
  results.push(await runBenchmark('Nested Fn::Map (3-deep, 3x3x3=27 items)', async () => {
    await include({
  ...
  results.push(await runBenchmark('Fn::Include chain (3-deep)', async () => {
    await include({
  ...
  results.push(await runBenchmark('Fn::Include chain (10-deep)', async () => {
    await include({
  ...
  // 10. Complex template
  results.push(await runBenchmark('Complex template (mixed features)', async () => {
    await include({
